...
- ✅ `IniPlugin` (v0.0.2) retains codec detection for UTF-8 BOM, UTF-16, and Latin-1 samples. Metadata records `encoding_info` alongside the unified `detector_lineage` payload so downstream tooling can trace the decision path.
