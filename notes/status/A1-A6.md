...
- **Token catalog:** New JSON detector surfaces `structured-settings-json`; reviewers should use `notes/snippets/token-catalog.py` to hash hunt excerpts before closing approvals.
