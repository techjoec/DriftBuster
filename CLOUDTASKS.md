...
- [ ] 1.4 Validation sweep.
  - [ ] 1.4.1 Re-run `dotnet test gui/DriftBuster.Gui.Tests/DriftBuster.Gui.Tests.csproj -c Release`.
  - [ ] 1.4.2 Capture storage-path validation notes in `notes/status/gui-research.md` and reflect the outcome in `docs/multi-server-demo.md`.
...
- [ ] 14.2 Notification adapters.
  ...
  - [ ] 14.2.3 Add Teams adapter (`tests/notifications/test_teams.py`).
- [ ] 14.3 CLI/GUI wiring.
...
<!-- PR prepared: 2025-10-22T09:12:13Z -->
<!-- make_pr anchor -->
