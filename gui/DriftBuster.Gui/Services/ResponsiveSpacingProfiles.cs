...
public static class ResponsiveSpacingProfiles
{
    public static IReadOnlyList<ResponsiveBreakpoint> MainWindow { get; } = new[]
    {
        new ResponsiveBreakpoint(
            ...
            {
                ["Layout.HeaderPadding"] = new Thickness(12, 8, 12, 8),
                ["Layout.ContentMargin"] = new Thickness(12),
                ["Layout.SectionCardPadding"] = new Thickness(12),
                ["Layout.PrimaryCardPadding"] = new Thickness(16),
                ["Layout.SectionSpacing"] = new Thickness(0),
                ["Toast.Width"] = 320d,
        ...
        new ResponsiveBreakpoint(
            ...
            Resources: new Dictionary<string, object>(StringComparer.Ordinal)
            {
                ["Layout.HeaderPadding"] = new Thickness(16, 8, 16, 8),
                ["Layout.ContentMargin"] = new Thickness(14),
                ["Layout.SectionCardPadding"] = new Thickness(14),
                ["Layout.PrimaryCardPadding"] = new Thickness(18),
                ["Layout.SectionSpacing"] = new Thickness(0),
                ["Toast.Width"] = 360d,
        ...
        new ResponsiveBreakpoint(
            ...
            Resources: new Dictionary<string, object>(StringComparer.Ordinal)
            {
                ["Layout.HeaderPadding"] = new Thickness(20, 10, 20, 10),
                ["Layout.ContentMargin"] = new Thickness(16),
                ["Layout.SectionCardPadding"] = new Thickness(16),
                ["Layout.PrimaryCardPadding"] = new Thickness(20),
                ["Layout.SectionSpacing"] = new Thickness(0),
                ["Toast.Width"] = 400d,
        ...
        new ResponsiveBreakpoint(
            ...
            Resources: new Dictionary<string, object>(StringComparer.Ordinal)
            {
                ["Layout.HeaderPadding"] = new Thickness(24, 12, 24, 12),
