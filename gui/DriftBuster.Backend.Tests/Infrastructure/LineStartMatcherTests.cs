...
public sealed class LineStartMatcherTests
{
    ...
    [
        ...
        ("ini", IniPlugin.ApacheHintPattern),
        ("ini", IniPlugin.NginxHintPattern),
        ("conf", ConfPlugin.LogstashBlockPattern),
        ("conf", ConfPlugin.NestedStanzaPattern),
        ...
        ("hcl", HclPlugin.BlockPattern),
        ("dockerfile", DockerfilePlugin.DirectivePattern),
        ("text", TextPlugin.OpensshSubsystemPattern),
        ("yaml", YamlPlugin.KeyColonPattern),
        ("yaml", YamlPlugin.DocumentStartPattern),
        ("yaml", YamlPlugin.DocumentEndPattern),
        ("yaml", YamlPlugin.ListMarkerPattern),
        ("yaml", YamlPlugin.CommentedKeyPattern),
