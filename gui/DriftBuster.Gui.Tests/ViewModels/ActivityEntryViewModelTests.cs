...
public sealed class ActivityEntryViewModelTests
{
    ...
    public void Clipboard_and_labels_reflect_severity_and_detail()
    {
        ...
        var entry = new ActivityEntryViewModel(ActivitySeverity.Error, "Scan failed", "Permission denied", timestamp);
        ...
        var infoEntry = new ActivityEntryViewModel(ActivitySeverity.Info, "Completed", string.Empty, timestamp);
