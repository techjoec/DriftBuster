...
internal abstract class ReNode
{
    ...
    public sealed class Subpattern(int? group, PythonReFlags addFlags, PythonReFlags delFlags, ReSubPattern body) : ReNode
    {
        public int? Group { get; } = group;

        public PythonReFlags AddFlags { get; } = addFlags;

        public PythonReFlags DelFlags { get; } = delFlags;
