...
internal sealed partial class ReMatcher
{
    ...
    private static bool IsWord(int code, bool unicode)
        => unicode ? PythonCharacterData.Word.Contains(code) : code < 128 && PythonCharacterData.AsciiWord.Contains(code);
    ...
    {
        ReOpcode.GroupRefIgnore => PythonCharacterData.AsciiLower(left) == PythonCharacterData.AsciiLower(right),
        ReOpcode.GroupRefUniIgnore => PythonCharacterData.Lower(left) == PythonCharacterData.Lower(right),
        _ => left == right,
    };
