...
/// <c>Resources/unicode_names.txt.gz</c> (written by <c>tools/parity/gen_unicode_names.py</c> from the interpreter's Unicode
/// 15.1 tables, each entry checked against <c>unicodedata.lookup</c>).
/// </summary>
/// <remarks>
