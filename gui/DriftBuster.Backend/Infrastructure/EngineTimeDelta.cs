...
/// (<see cref="EngineValueException"/>) texts.
/// </summary>
[StructLayout(LayoutKind.Auto)]
public readonly record struct EngineTimeDelta : IComparable<EngineTimeDelta>
{
    ...
    private EngineTimeDelta(int days, int seconds, int microseconds)
    {
        Days = days;
        Seconds = seconds;
    ...
    public static EngineTimeDelta FromMicroseconds(BigInteger total)
    {
        ...
        {
            throw new OverflowException("day count too large for a time interval");
        }
        ...
        return new EngineTimeDelta(dayCount, (int)remainder, (int)microseconds);
    }
    ...
    /// </summary>
    /// <exception cref="EngineValueException">A NaN argument.</exception>
    /// <exception cref="OverflowException">An infinite argument, or a result out of range.</exception>
    public static EngineTimeDelta FromFloats(double? days = null, double? seconds = null, double? minutes = null, double? hours = null)
    {
    ...
    public static EngineTimeDelta operator +(EngineTimeDelta left, EngineTimeDelta right) => FromMicroseconds(left.TotalMicroseconds + right.TotalMicroseconds);

    public static bool operator <(EngineTimeDelta left, EngineTimeDelta right) => left.CompareTo(right) < 0;
    ...
    public int CompareTo(EngineTimeDelta other) => TotalMicroseconds.CompareTo(other.TotalMicroseconds);
    ...
    private static BigInteger FromDouble(double value)
    {
        ...
        {
            throw new EngineValueException("cannot convert float NaN to integer", nameof(value));
        }
