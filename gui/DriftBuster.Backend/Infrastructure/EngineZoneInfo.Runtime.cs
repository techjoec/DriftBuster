...
/// </remarks>
public sealed partial class EngineZoneInfo
{
    ...
    private long RuntimeUtcOffset(EngineDateTime moment)
    {
    ...
    private EngineDateTime RuntimeFromUtc(EngineDateTime moment)
    {
