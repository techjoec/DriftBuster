...
/// </remarks>
public sealed class PythonSort<T>
{
    ...
    private PythonSort(T[] items, Func<T, T, bool> lessThan)
    {
        _a = items;
        _lessThan = lessThan;
    }
    ...
    public static void Sort(IList<T> items, Func<T, T, bool> lessThan)
    {
        ...
        new PythonSort<T>(buffer, lessThan).Run();
    ...
    {
        private readonly PythonSort<T> _sort;
        private readonly T[] _a;
        ...
        public LowMerge(PythonSort<T> sort, int baseA, int lengthA, int baseB, int lengthB)
        {
            _sort = sort;
            _a = sort._a;
    ...
    private sealed class HighMerge
    {
        ...
        public HighMerge(PythonSort<T> sort, int baseA, int lengthA, int baseB, int lengthB)
        {
            _sort = sort;
            _a = sort._a;
